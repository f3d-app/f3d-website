...
### `-o`, `--point-sprites`_`=<none|sphere|gaussian>`_  <small>(_string_, default: `none`)</small> {#--point-sprites}
...
### `-p`, `--blending`  <small>(_string_, default: `ddp`)</small> {#--blending}
...
### `-a`, `--anti-aliasing`  <small>(_string_, default: `fxaa`)</small> {#--anti-aliasing}
