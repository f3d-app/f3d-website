...
See the dedicated [build](/dev/BUILD_WASM) guide, this [example app](https://github.com/f3d-app/f3d/blob/master/webassembly/example.html) which you can test live [here](https://f3d.app/web/)!
