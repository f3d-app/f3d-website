...
* [getDPIScale](classf3d_1_1utils.md#classf3d_1_1utils_1a3875daede98917c9d18efa5191cb7381)
...
```cpp
static double f3d::utils::getDPIScale()
```




Calculate the primary monitor system zoom scale base on DPI. Only supported on Windows platform. Return 1.0 on other platforms.
