...
* [add](classf3d_1_1scene.md#classf3d_1_1scene_1ab70ea40d189299d4b7f2e756fb49de4a)
...
* [getAnimationKeyFrames](classf3d_1_1scene.md#classf3d_1_1scene_1a01d9a288ebf5f93928625f590901c8d4)
* [getAnimationName](classf3d_1_1scene.md#classf3d_1_1scene_1a8f16b47d2cfc926655c7c3cd8a6c65cd)
* [getAnimationNames](classf3d_1_1scene.md#classf3d_1_1scene_1a39b5c7431d999e91b5d41f709472ad51)
...
Add and load provided files into the scene Already added file will NOT be reloaded If it fails to loads a file, it clears the scene and throw a [load\_failure\_exception](structf3d_1_1scene_1_1load__failure__exception.md). On other failure, throw a [load\_failure\_exception](structf3d_1_1scene_1_1load__failure__exception.md).
...
Add and load provided mesh into the scene If it fails to load the mesh, it clears the scene and throw a [load\_failure\_exception](structf3d_1_1scene_1_1load__failure__exception.md). On other failure, throw a [load\_failure\_exception](structf3d_1_1scene_1_1load__failure__exception.md).
...
### Function add {/* #classf3d_1_1scene_1ab70ea40d189299d4b7f2e756fb49de4a */}

![][public]


```cpp
virtual scene & f3d::scene::add(const std::byte *buffer, std::size_t size)=0
```




Add and load provided buffer into the scene as it was file. Automatically picks the right reader to use, unless you use VTK < 9.6.20260128, then it requires the use of `scene.force_reader`. If it fails to loads the buffer, it clears the scene and throw a [load\_failure\_exception](structf3d_1_1scene_1_1load__failure__exception.md). On other failure, throw a [load\_failure\_exception](structf3d_1_1scene_1_1load__failure__exception.md).
...
Return true if provided file in path uses a supported extension, exists and its content correspond to a supported file format, false otherwise. content validation is only performed with VTK >= 9.6.20260228 scene.force_reader is taken into account and plugin should be loaded for their readers to be found.
...
### Function getAnimationKeyFrames {/* #classf3d_1_1scene_1a01d9a288ebf5f93928625f590901c8d4 */}

![][public]


```cpp
virtual std::vector< double > f3d::scene::getAnimationKeyFrames()=0
```




Get animation keyframe's time of currently added files. Can be used in loadAnimationTime to request a specific keyframe. Returns empty vector if there is no animations.
...
* `qualifiedname {"type":"element","name":"qualifiedname","attributes":{},"children":[{"type":"text","text":"f3d::scene::getAnimationKeyFrames"}]}`
*/}
...
### Function getAnimationName {/* #classf3d_1_1scene_1a8f16b47d2cfc926655c7c3cd8a6c65cd */}

![][public]


```cpp
virtual std::string f3d::scene::getAnimationName(int index=-1)=0
```
...
* `qualifiedname {"type":"element","name":"qualifiedname","attributes":{},"children":[{"type":"text","text":"f3d::scene::getAnimationName"}]}`
*/}

### Function getAnimationNames {/* #classf3d_1_1scene_1a39b5c7431d999e91b5d41f709472ad51 */}
...
* `qualifiedname {"type":"element","name":"qualifiedname","attributes":{},"children":[{"type":"text","text":"f3d::scene::getAnimationNames"}]}`
*/}
