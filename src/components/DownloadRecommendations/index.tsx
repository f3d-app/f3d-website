      ...
      <div className="container">
        <div className={styles.container}>
          <div className={styles.downloadOption}>
            ...
            >
              Download <b>F3D</b><br /><small><Icon icon={osLinks.icon} className={styles.buttonIcon} /><b>{operatingSystem}</b> ({osLinks.binaries[0].short})</small>
            </Link>
            <ul className={styles.details}>
              <li>{osLinks.binaries[0].long}</li>
              <li>{osLinks.binaries[0].size} - <a data-tooltip-id="digest0" className={styles.digestLink}>sha256</a></li>
          ...
          <div className={styles.downloadOption}>
            ...
            >
              Download <b>F3D</b><br /><small><Icon icon={osLinks.icon} className={styles.buttonIcon} /><b>{operatingSystem}</b> ({osLinks.binaries[1].short})</small>
            </Link>
            <ul className={styles.details}>
              <li>{osLinks.binaries[1].long}</li>
              <li>{osLinks.binaries[1].size} - <a data-tooltip-id="digest1" className={styles.digestLink}>sha256</a></li>
        ...
        <div className={styles.footer}>or see other available versions below</div>
      </div>
    </section>
  );
}
