...
const linuxDistros = [
  {
    name: "Ubuntu",
    url: "https://packages.ubuntu.com/search?keywords=f3d&searchon=names&exact=1&suite=all&section=all",
  },
  {
    name: "Debian",
    url: "https://packages.debian.org/search?keywords=f3d&searchon=names&exact=1&suite=all&section=all",
  },
  {
    name: "Arch Linux",
    url: "https://archlinux.org/packages/extra/x86_64/f3d/",
  },
  { name: "Fedora", url: "https://packages.fedoraproject.org/pkgs/f3d/f3d/" },
  { name: "openSUSE", url: "https://software.opensuse.org/package/f3d" },
  {
    name: "OpenMandriva",
    url: "https://github.com/OpenMandrivaAssociation/f3d",
  },
  {
    name: "Mageia",
    url: "https://madb.mageialinux-online.org/rpmshow?rpm=f3d&repo=9-SRPMS-core-release&distribution=9&architecture=x86_64&graphical=0",
  },
  {
    name: "ALT Linux",
    url: "https://packages.altlinux.org/en/sisyphus/srpms/f3d/",
  },
  { name: "Guix", url: "https://hpc.guix.info/package/f3d" },
  {
    name: "Flathub",
    url: "https://flathub.org/apps/details/io.github.f3d_app.f3d",
  },
...
export default function DownloadPage(): ReactNode {
  ...
  return (
    <Layout
      title="Download"
      description="Download F3D and start using it right now."
    >
        ...
        <div className="container">
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>
              <BrowserOnly
                fallback={<span>Released on {downloadLinks.date}</span>}
              >
                {() => (
                  <span>
                    Released on{" "}
                    {new Date(downloadLinks.date).toLocaleDateString("en-US", {
                      year: "numeric",
                      month: "long",
                      day: "numeric",
                    })}
            ...
            <div className={styles.installationSection}>
              <div className={styles.sectionHeader}>
                ...
                <p className={styles.sectionDescription}>
                  Choose your operating system below to download F3D for your
                  platform. We support Windows, macOS, and Linux with multiple
                  ...
                  >
                    ...
                    {platform === "macOS" && (
                      <>
                        <Admonition
                          type="warning"
                          title={`Installing on ${platform}`}
                        >
                          <p>
                            macOS package is not signed, see the{" "}
                            <Link to="/docs/next/user/LIMITATIONS_AND_TROUBLESHOOTING#macos">
                              troubleshooting section
                            </Link>{" "}
                            for a workaround if needed.
                          </p>
                        </Admonition>
                    ...
                    <div className={styles.additionalSection}>
                      ...
                      <p className={styles.packageDescription}>
                        Looking for other versions? We also provide access to
                        development builds and previous releases.
                      </p>
                      <div className={styles.additionalGrid}>
                        <div
                          className={`${styles.additionalCard} ${styles.nightly}`}
                        >
                          <div className={styles.additionalCardHeader}>
                            <Icon
                              icon="material-symbols:nightlight"
                              className={`${styles.additionalCardIcon} ${styles.nightly}`}
                            />
                            <h5
                              className={`${styles.additionalCardTitle} ${styles.nightly}`}
                            >
                              Nightly Builds
                            </h5>
                          </div>
                          <p className={styles.additionalCardDescription}>
                            Latest development version with cutting-edge
                            features. While usually stable, some bugs may occur.
                          </p>
                          <a
                        ...
                        <div
                          className={`${styles.additionalCard} ${styles.history}`}
                        >
                          <div className={styles.additionalCardHeader}>
                            <Icon
                              icon="material-symbols:history"
                              className={`${styles.additionalCardIcon} ${styles.history}`}
                            />
                            <h5
                              className={`${styles.additionalCardTitle} ${styles.history}`}
                            >
                              Previous Versions
                            </h5>
                          </div>
                          <p className={styles.additionalCardDescription}>
                            Browse and download older stable releases of F3D for
                            compatibility needs.
                          </p>
                          <a
            ...
            <div className={styles.bottomGrid}>
              <div className={styles.libraryCard}>
                ...
                <a href="https://pypi.org/project/f3d/">
                  <Heading as="h3" className={styles.libraryTitle}>
                    Python Library
                  </Heading>
                </a>
                <p className={styles.libraryDescription}>
                  Install F3D as a Python package to integrate 3D rendering into
              ...
              <div className={styles.libraryCard}>
                ...
                <p className={styles.libraryDescription}>
                  Use F3D in web applications with our JavaScript/WebAssembly
