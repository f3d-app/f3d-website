...
function DonationWidget({
  ...
  setShowPartnershipModal: (show: boolean) => void;
}): ReactNode {
  ...
  const formatAmount = (amount: any) => {
    ...
    const membership =
      donationType === "monthly" && membershipTiers[amount]
  ...
  const handleDonation = () => {
    ...
    if (!paymentLink) {
      alert(
        "Payment link not available for this amount. Please try a different amount.",
      );
      return;
    }
  ...
  return (
    ...
    >
      <div style={{ textAlign: "center", marginBottom: "1.5rem" }}>
        ...
        />
        <Heading as="h3" style={{ margin: "0.5rem 0" }}>
          Support F3D Development
        </Heading>
        ...
        <div className={styles.modalOverlay}>
          <div className={styles.modalContent}>
            ...
            <div className={styles.modalBody}>
              <p>
                We'd love to chat with{" "}
                <strong>companies and organizations</strong> interested in
                sponsoring F3D at an industry level!
              </p>
              ...
              <ul style={{ marginLeft: "1.5rem", marginBottom: "1.5rem" }}>
                ...
                <li>
                  Get your logo on a strategic location and get public
              ...
              <ul style={{ marginLeft: "1.5rem", marginBottom: "1.5rem" }}>
                ...
                <li>
                  Businesses wanting to ensure F3D's long-term sustainability
                </li>
              </ul>

              <Admonition type="info" title="Important">
                Looking for professional help with support, consulting,
                training, or custom development? We can also connect you with
                our expert partner companies.
              </Admonition>
            </div>
...
export default function ThanksPage(): ReactNode {
  ...
  const [showPartnershipModal, setShowPartnershipModal] =
      ...
      <main>
        <section>
          <div className={`container ${styles.container}`}>
            <BrowserOnly>{() => <DownloadStatus />}</BrowserOnly>
            ...
            >
              ...
              <div style={{ paddingRight: "2rem" }}>
                ...
                <div style={{ fontSize: "1.1rem", lineHeight: "1.6" }}>
                  <p>
                    F3D is a <strong>free and open source</strong> 3D viewer
                    that helps thousands of users visualize, render and interact
                    with 3D models every day. Our mission is to provide a fast,
                    lightweight, and powerful tool that remains accessible to
                    everyone.
                  </p>

                  <p>
                    As an open source project, F3D relies on the generosity of
                    users like you to:
                  </p>
                  ...
                  <ul style={{ marginLeft: "1.5rem", marginBottom: "1.5rem" }}>
                    ...
                    <li>
                      Maintain compatibility with support for many file formats
                    </li>
                    <li>Fix bugs and regressions</li>
                    <li>Provide free support to our users</li>
                    <li>
                      Keep our infrastructure running (git lfs, servers, domain
                      name)
                    </li>
                    <li>
                      Ensure F3D remains free (as in beer and speech!) for
                      everyone
                    </li>
                  </ul>

                  <p>
                    Your contribution, no matter the size, makes a real
                    difference in keeping F3D alive and thriving and will be
                    acknowledged in our releases notes. Thank you for supporting
                    our work!
                  </p>

                  <p>If you donate monthly, you get a few perks!</p>
                  ...
                  <div className={styles.tierCardsGrid}>
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, #CD7F32 0%, #B8722A 100%)",
                    ...
                    >
                      ...
                      <div style={{ fontSize: "0.75rem" }}>Discord role</div>
                    </div>
                    ...
                    >
                      ...
                      <div style={{ fontSize: "0.75rem" }}>VIP channel</div>
                    </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <Icon
                          ...
                          style={{ fontSize: "0.9rem", color: "#FFA500" }}
                        />
                      </div>
                      <div
                        style={{
                      ...
                      <div style={{ fontSize: "0.75rem" }}>Vote features</div>
                    </div>
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, #E5E4E2 0%, #D3D3D3 100%)",
                        padding: "0.5rem 0.25rem",
                        borderRadius: "6px",
                        color: "#333",
                        position: "relative",
                    ...
                    >
                      ...
                      <div style={{ fontSize: "0.7rem" }}>README credit</div>
                    </div>
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, #B9F2FF 0%, #87CEEB 100%)",
                        padding: "0.5rem 0.25rem",
                        borderRadius: "6px",
                        color: "#333",
                        position: "relative",
                    ...
                    >
                      ...
                      <div style={{ fontSize: "0.7rem" }}>Gallery feature</div>
                    </div>
                  </div>
                  ...
                  <p>
                    ...
                    <a href="https://discord.f3d.app">discord</a> once you start
                    donating.
                  </p>

                  <p>
                    If your company is using F3D in any capacity and you want to
                    ensure F3D keeps growing and being maintained, we would love
                    to hear from you!
                  </p>
                  <p>
                    You can sponsor F3D through the non-profit{" "}
                    <strong>F3D-APP FOUNDATION</strong> and we can acknowledge
                    your support by displaying your logo on our README.md as
                    well as sharing about your support whenever we get the
                    chance.
                  </p>
                  ...
                  >
                    ...
                    />
                    <strong>100% of donations</strong> go directly to F3D
